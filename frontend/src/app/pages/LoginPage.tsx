    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 light:from-slate-50 light:via-slate-100 light:to-slate-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white light:text-slate-900 mb-2">Welcome Back</h1>
          <p className="text-slate-400 light:text-slate-600">Sign in to continue to AI Code Review</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-slate-700 light:border-slate-300 bg-slate-800 light:bg-slate-100 text-purple-500 focus:ring-purple-500 focus:ring-offset-0"
                />
                <span className="text-sm text-slate-400 light:text-slate-600">Remember me</span>
              </label>
              <Link
                to="/forgot-password"
        ...
        <p className="text-xs text-slate-500 light:text-slate-600 text-center mt-6">
