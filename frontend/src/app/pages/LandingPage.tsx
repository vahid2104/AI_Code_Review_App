...
const features = [
  {
    ...
    title: "Bug Detection",
    description:
      "Automatically identify potential bugs and logical errors before they reach production.",
  },
  {
    icon: Shield,
    title: "Security Analysis",
    description:
      "Detect security vulnerabilities and common attack vectors in your codebase.",
  },
  {
    icon: Eye,
    title: "Code Quality Suggestions",
    description:
      "Get actionable recommendations to improve code structure and patterns.",
  },
  {
    icon: Wrench,
    title: "Readability Improvements",
    description:
      "Enhance code clarity with suggestions for better naming and documentation.",
  },
  {
    icon: GraduationCap,
    title: "Developer Learning Support",
    description:
      "Learn best practices and patterns through AI-powered explanations.",
  },
  {
    icon: History,
    title: "Review History",
    description:
      "Track all your code reviews and see your improvement over time.",
  },
];
...
export function LandingPage() {
  ...
  const startReviewLink = isAuthenticated ? "/app/new-review" : "/login";
  const dashboardLink = isAuthenticated ? "/app" : "/login";
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-xl text-slate-300 mb-10 leading-relaxed">
            Detect bugs, improve readability, and get instant AI-powered
            feedback before merging your code.
          </p>
            ...
            <div className="p-8">
              ...
              <div className="bg-slate-950/80 rounded-lg p-4 font-mono text-sm">
                ...
                <div className="text-slate-300 ml-4">
                  ...
                  <span className="text-purple-400">var</span> i ={" "}
              ...
              <div className="space-y-4">
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
                  ...
                  <p className="text-xs text-slate-400 mb-2">
                    Replace 'var' with 'let' or 'const' to avoid scope issues
                    and follow ES6 best practices.
                  </p>
                ...
                <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                  ...
                  <p className="text-xs text-slate-400 mb-2">
                    Modern array methods are more concise and readable than
                    manual loops.
                  </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400">
            Everything you need to write better, safer code
          </p>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <div className="p-12 rounded-2xl bg-gradient-to-br from-purple-500/10 to-cyan-500/10 border border-purple-500/20 backdrop-blur">
          ...
          <p className="text-slate-300 mb-8">
            {isAuthenticated
              ? "Continue reviewing your code and track your progress in the dashboard."
              : "Join developers using AI-powered code reviews to ship better software."}
          </p>
          <Link
            to={startReviewLink}
          ...
          >
            {isAuthenticated ? "Start New Review" : "Get Started Free"}
            <ArrowRight className="w-5 h-5" />
          </Link>
        </div>
      </section>
